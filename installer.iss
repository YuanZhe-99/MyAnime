...
#ifdef ARM64
OutputBaseFilename=MyAnime_{#SetupSetting("AppVersion")}_arm64_Setup
#else
OutputBaseFilename=MyAnime_{#SetupSetting("AppVersion")}_Setup
#endif
...
VersionInfoProductVersion=1.2.3
Compression=lzma2
